package com.hemant.springhibernate.controller;
...
import com.hemant.springhibernate.bean.EmployeeBean;
import com.hemant.springhibernate.model.Employee;
import com.hemant.springhibernate.service.EmployeeService;
...
public class EmployeeController {
	...
	public ModelAndView saveEmployee(@Valid @ModelAttribute("command") EmployeeBean employeeBean,
		...
		if(result.hasErrors()) {
			...
			return new ModelAndView("redirect:/employee/employees.html");
		}
	}
